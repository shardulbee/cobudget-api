...
module GeneratedUrlHelpers
  # Sigs for route /institution_authorization/begin(.:format)
  sig { params(args: T.untyped, kwargs: T.untyped).returns(String) }
  def institution_authorization_begin_path(*args, **kwargs); end

  sig { params(args: T.untyped, kwargs: T.untyped).returns(String) }
  def institution_authorization_begin_url(*args, **kwargs); end

  # Sigs for route /institution_authorization/complete(.:format)
  sig { params(args: T.untyped, kwargs: T.untyped).returns(String) }
  def institution_authorization_complete_path(*args, **kwargs); end

  sig { params(args: T.untyped, kwargs: T.untyped).returns(String) }
  def institution_authorization_complete_url(*args, **kwargs); end
